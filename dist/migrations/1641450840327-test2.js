...
exports.test21641450840327 = void 0;
class test21641450840327 {
    constructor() {
        this.name = 'test21641450840327';
    }
    async up(queryRunner) {
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "gender"`);
        await queryRunner.query(`DROP TYPE "public"."user_gender_enum"`);
        await queryRunner.query(`CREATE TYPE "public"."user_sex_enum" AS ENUM('male', 'female', 'other')`);
        await queryRunner.query(`ALTER TABLE "user" ADD "sex" "public"."user_sex_enum" NOT NULL`);
...
exports.test21641450840327 = test21641450840327;
